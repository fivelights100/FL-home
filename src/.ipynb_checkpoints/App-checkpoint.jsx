          ...
          <div className="grid3">
            <article className="mini">
              <div className="mini-top">
                <span className="mini-tag">v1.0.0 LTS</span>
                <span className="mini-tag glow"></span>
              </div>
              <h3>FL 가계부</h3>
              <p>FL Database와 Excel의 높은 연동성을 보여드립니다.</p>
            </article>
        ...
        <section id="contact" className="card">
          ...
          <div className="contact-row">
            <div className="contact-item">
              ...
              <div className="contact-value">fivelights100@gmail.com</div>
            </div>
            <div className="contact-item">
              <div className="contact-label">GitHub</div>
              <div className="contact-value">https://github.com/fivelights100/FL-home</div>
            </div>
            <div className="contact-item">
              <div className="contact-label">Status</div>
              <div className="contact-value">Online</div>
            </div>
          </div>
        </section>
      </main>
